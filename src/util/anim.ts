...
export namespace easing {
  ...
  export const bounceEasyOut: () => Timing = () => makeEaseOut(bounceFn)
   ...
   */
  export const elastic = (x = 1.5) => timeFraction =>
  ...
  export const bounceEaseInOut: () => Timing = () => makeEaseInOut(bounceFn)

  var c = 1,
    b = 0
  export const easeInQuad: () => Timing = () => ({ fn: d => (x, t) => c * (t /= d) * t + b } as any)

  export const easeOutQuad: () => Timing = () => ({ fn: d => (x, t) => -c * (t /= d) * (t - 2) + b } as any)
