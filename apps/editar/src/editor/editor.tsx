import { Box, closeModal, Div, findChildren, IEditor, React, showInModal } from 'accursed'
        ...
        <GoToLineForm
          ...
          onSubmit={lineNumber => {
            ...
            const validLineNumber = Math.max(
              0,
              Math.min(lineNumber - 1, this.currentDocumentEditor.editor.textBuf.getLineCount() - 1),
              0
            )
