import { listtable, Node, prompt, screen, React } from 'accursed'
...
const t1 = React.render(<text parent={screen2} content=" " width={1} height={1} top={0} left={0}></text>)
const t2 = React.render(<text parent={screen2} content=" " width={1} height={1}  top={1} left={3}></text>)
