...
import { FontSelectedAction, FontsErrorAction, FontsShowAction, TextChangeAction, ACTIONS, FontsMetadataShowAction } from './fontsAction';
...
export type AllActions = FontSelectedAction|FontsErrorAction|FontsShowAction|TextChangeAction|FontsMetadataShowAction
