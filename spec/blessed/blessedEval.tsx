...
import { Br, Div, filterChildren, findChildren, React } from '../../src'
import { installExitKeys } from '../../src/blessed/util'
import { BoxOptions, Button, isElement, Textarea } from '../../src/blessedTypes'
...
function test() {
  ...
  const app = (
    <Div {...opts} width="100%" border="line" height="100%" parent={screen} style={{ bg: 'red' }}>
      <button
        {...opts}
        ref={ref1}
        top="80%"
