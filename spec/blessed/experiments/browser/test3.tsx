...
import { createScreen, React, Accordion, AccordionBlock, Button2, Br, ScreenOptions, Screen, Column, Columns, TabPanel, Tab, TabLabel, TabBody, installFocusHandler, filterDescendants, isElement, ButtonOptions, installExitKeys } from '../../../../src';
...
(async ()=>{
  ...
  const focusable: ()=>ButtonOptions = ()=>({
    focusable: true, clickable: true, keys: true, mouse: true, keyable: true, 
    style: {
      border: {
        fg: 'blue',
      },
  ...
  <AccordionBlock label="Contacts" labelStyle={focusable().style}>
    {words(12).join(' ')}<Br/>
    <Button2 {...focusable()} onClick={e=>{}}>click me</Button2><Br/>
    {words(12).join(' ')}
  </AccordionBlock>
  <AccordionBlock  label="Addresses"  labelStyle={focusable().style}>
    {words(12).join(' ')}<Br/>
    <Button2 {...focusable()} onClick={e=>{}}>click me 2</Button2><Br/>
    {words(12).join(' ')}
  </AccordionBlock>
  <AccordionBlock  label="Orders"  labelStyle={focusable().style}>
    {words(12).join(' ')}<Br/>
    <Button2 {...focusable()} onClick={e=>{}}>click me 3</Button2><Br/>
    {words(12).join(' ')}
  </AccordionBlock>
  {}
  </Accordion>
  ...
  <TabPanel>
    <Tab >
      <TabLabel {...focusable()} fg="blue">Cart</TabLabel>
      <TabBody>
    {words(66).join(' ')}<Br/>
    <Button2 {...focusable()} onClick={e=>{}}>click me 3</Button2><Br/>
    {words(66).join(' ')}
    ...
    <Tab>
      <TabLabel {...focusable()} fg="blue">Favorites</TabLabel>
      <TabBody>
    {words(66).join(' ')}<Br/>
    <Button2 {...focusable()} onClick={e=>{}}>click me 3</Button2><Br/>
    {words(66).join(' ')}
    ...
    <Tab>
      <TabLabel {...focusable()} fg="blue">Products</TabLabel>
      <TabBody>
    {words(66).join(' ')}<Br/>
    <Button2 {...focusable()} onClick={e=>{}}>click me 3</Button2><Br/>
    {words(66).join(' ')}
