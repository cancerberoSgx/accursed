...
import { Tab, TabBody, TabLabel, TabPanel, Button2 } from '../src/jsx-components'
...
describe('button2', () => {
  ...
  it('should render', async done => {
    try {
      ...
      const t1 = (
        <Div >
          <Button2 border="line" style={{bg: 'red', focus: {bg: 'blue'}}} mouse={true} clickable={true} focusable={true} onClick={e=>{  
